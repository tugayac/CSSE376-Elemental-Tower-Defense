...
public class TowerTest {
	...
	@Before
	public void setUp(){
		FireTower = Tower.createTower(Frame.Elements.FIRE, new Point2D.Double(1, 1));
		WaterTower = Tower.createTower(Frame.Elements.WATER, new Point2D.Double(2, 2));
		LightTower = Tower.createTower(Frame.Elements.LIGHT, new Point2D.Double(3, 3));
		EarthTower = Tower.createTower(Frame.Elements.EARTH, new Point2D.Double(4, 4));
		AirTower = Tower.createTower(Frame.Elements.AIR, new Point2D.Double(5, 5));
	}
	...
	public void testCanGetElement(){
		assertEquals(Frame.Elements.FIRE, FireTower.getElement());
		assertEquals(Frame.Elements.WATER, WaterTower.getElement());
		assertEquals(Frame.Elements.LIGHT, LightTower.getElement());
		assertEquals(Frame.Elements.EARTH, EarthTower.getElement());
		assertEquals(Frame.Elements.AIR, AirTower.getElement());
	}
