...
public class ControlPanelLocalizationTest {
	...
	public void testLocalityTR() {
		...
		assertEquals("Dü\u015Fman Dalga Bilgileri",
		...
		assertEquals("Seçili Dü\u015Fman", strings.getString("selEnemyInfo"));
		...
		assertEquals("Seçilebilir Kuleler", strings.getString("availTowers"));
