...
public class TowerTest {
	...
	private static Tower FireTower, WaterTower, LightTower, EarthTower,
			AirTower;

	@Before
	public void setUp() {
		FireTower = new TowerFire(new Point2D.Double(1, 1), 100);
		WaterTower = new TowerWater(new Point2D.Double(2, 2), 100);
		LightTower = new TowerLight(new Point2D.Double(3, 3), 100);
		EarthTower = new TowerEarth(new Point2D.Double(4, 4), 100);
		AirTower = new TowerAir(new Point2D.Double(5, 5), 100);
	}
